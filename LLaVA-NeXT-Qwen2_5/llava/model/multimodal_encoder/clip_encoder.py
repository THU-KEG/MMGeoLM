...
from transformers import CLIPVisionModel, CLIPImageProcessor, CLIPVisionConfig, AltCLIPVisionModel
...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained(self.vision_tower_name)
        self.vision_tower = AltCLIPVisionModel.from_pretrained(self.vision_tower_name, device_map=device_map)
